...
alias ww_vpn_up='sudo route add -net 192.168.3.0/24 gw 192.168.4.1 metric 2; sudo route add default gw 192.168.4.1 metric 2; sudo nmcli c up cd/main-ovpn; c0rc_info "sleep for 5 secs ..."; sudo systemctl restart dnsmasq.service; c0rc_info "done"'
